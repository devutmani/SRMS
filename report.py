...
class ReportClass:
    def __init__(self, root):
        ...
        Button(
            ...
            fg="white",
            cursor="hand2"
        ).place(x=780, y=100, width=100, height=35)
        ...
        Button(
            ...
            fg="white",
            cursor="hand2"
        ).place(x=900, y=100, width=100, height=35)
        ...
        Button(
            ...
            fg="white",
            cursor="hand2"
        ).place(x=500, y=360, width=150, height=40)
    ...
    def search(self):
        try:
            ...
            cur.execute(
                "SELECT * FROM result WHERE roll=%s",
                (self.var_search.get(),)
            )
    ...
    def delete(self):
        try:
            ...
            if op:
                cur.execute(
                    "DELETE FROM result WHERE rid=%s",
                    (self.var_id,)
                )
